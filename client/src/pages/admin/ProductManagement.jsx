  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-[#E60000]'}`}>Product Management</h1>
          ...
          <div className={modalBox}>
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-3">
                <div className={`p-2 rounded-xl ${editingProduct ? 'bg-yellow-100' : 'bg-[#FFF0F0]'}`}>
                  {editingProduct
        ...
        <div className={modalBg}>
          <div className={`w-full max-w-sm rounded-2xl shadow-2xl p-6 ${isDark ? 'bg-slate-800 border border-slate-700' : 'bg-white'}`}>
            ...
            <p className={`text-sm mb-5 ${isDark ? 'text-slate-400' : 'text-gray-600'}`}>
              This action is <span className="font-semibold text-[#FF0000]">permanent</span> and cannot be undone. Are you sure you want to delete this product?
            </p>
      ...
      {importResult && (
        <div className={modalBg}>
          <div className={`w-full max-w-md rounded-2xl shadow-2xl p-6 ${isDark ? 'bg-slate-800 border border-slate-700' : 'bg-white'}`}>
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-3">
                <div className={`p-2 rounded-xl ${importResult.error ? 'bg-[#FFF0F0]' : 'bg-green-100'}`}>
                  {importResult.error
                    ? <AlertTriangle size={18} className="text-[#FF0000]" />
            ...
            {importResult.error ? (
              <p className="text-sm text-[#FF0000]">{importResult.error}</p>
            ) : (
